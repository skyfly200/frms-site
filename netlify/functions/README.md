...
| `WELCOME_CC` | – | Comma-separated address(es) to CC on every welcome email (visible to the member) |
| `WELCOME_BCC` | – | Comma-separated address(es) to BCC on every welcome email (hidden from the member) |
